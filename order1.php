		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12"><span class="featureitem">5 Modes: High | Meduim | Strobe | SOS</span>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12"><span class="featureitem">Normal Price: <span style="text-decoration: line-through">$116.00</span></span>
						</div>
					</div>
				</div>
			</div>
