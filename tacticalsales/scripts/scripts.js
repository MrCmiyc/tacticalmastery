    ...
    api("order", paramString, function (e) {
        ...
        switch (json.result) {
            case 'SUCCESS':
                ...
                document.location = '/tacticalsales/us_recharge.html?orderId=' + window.myOrderID;
                break;
            case 'ERROR':
                if (json.message) {
    ...
    if (pageInfo != undefined) {
        ...
        //overwrite links with class to include our affiliate tracking fields
            $('a.ilink').each( function(){
                ...
                var goHere = 'https://tacticalmastery.com/tacticalsales/index.html?ref=' + location.pathname.substring(1) + iQs;
